...
if [ ! -f "/home/julia/workspace/build/gz-utils2/doxygen/html/index.html" ]; then
  make doc
  if [ ! -f "/home/julia/workspace/build/gz-utils2/doxygen/html/index.html" ]; then
...
# Dry run
aws s3 sync --dryrun /home/julia/workspace/build/gz-utils2/doxygen/html/ s3://gazebosim.org/api/utils/2/
...
if [ "$ans" = "n" ] || [ "$ans" = "N" ]; then
  ...
  aws s3 sync /home/julia/workspace/build/gz-utils2/doxygen/html/ s3://gazebosim.org/api/utils/2/
