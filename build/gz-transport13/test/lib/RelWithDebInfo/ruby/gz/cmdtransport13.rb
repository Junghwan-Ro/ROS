...
# Constants.
LIBRARY_VERSION = '13.0.0~pre1'
COMMANDS = {
  "service" => "/home/julia/workspace/build/gz-transport13/bin/gz-transport-service",
  "topic" => "/home/julia/workspace/build/gz-transport13/bin/gz-transport-topic",
}

#
# Class for the Gazebo transport command line tools.
#
class Cmd
  def execute(args)
    command = args[0]
