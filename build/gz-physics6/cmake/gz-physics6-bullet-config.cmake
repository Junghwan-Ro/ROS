# - Config file for the gz-physics6-bullet component
#
# This should only be invoked by gz-physics6-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-physics6 COMPONENTS bullet)
#
# This creates the following targets:
#
#   Component library target                - gz-physics6::gz-physics6-bullet
#   Alternative target name                 - gz-physics6::bullet
...
# this is discouraged:
#
#   gz-physics6-bullet_LIBRARY  - Component library (actually contains gz-physics6::bullet)
#
# We will also set gz-physics6-bullet_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-physics6-bullet_CONFIG_INCLUDED)
  return()
endif()
set(gz-physics6-bullet_CONFIG_INCLUDED TRUE)

if(NOT gz-physics6-bullet_FIND_QUIETLY)
  message(STATUS "Looking for gz-physics6-bullet -- found version 6.3.0")
endif()
...
# dependencies.
if(gz-physics6-bullet_FIND_REQUIRED)
...
# dependencies.
if(gz-physics6-bullet_FIND_QUIETLY)
...
if(NOT gz-physics6-bullet_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-physics6-bullet")
endif()
...
if(NOT TARGET gz-physics6::gz-physics6-bullet)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-physics6-bullet-targets.cmake")

  # Create a simplified imported target name for the bullet library.
  # You can link to this target instead of the bullet library.
  add_library(gz-physics6::bullet INTERFACE IMPORTED)
  set_target_properties(gz-physics6::bullet PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-physics6::gz-physics6-bullet")
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-physics6::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-physics6::gz-physics6-bullet")
endif()

set(gz-physics6-bullet_LIBRARY gz-physics6::gz-physics6-bullet)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-physics6-bullet "gz-physics6-bullet")
