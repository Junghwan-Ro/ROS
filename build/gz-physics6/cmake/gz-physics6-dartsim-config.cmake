# - Config file for the gz-physics6-dartsim component
#
# This should only be invoked by gz-physics6-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-physics6 COMPONENTS dartsim)
#
# This creates the following targets:
#
#   Component library target                - gz-physics6::gz-physics6-dartsim
#   Alternative target name                 - gz-physics6::dartsim
...
# this is discouraged:
#
#   gz-physics6-dartsim_LIBRARY  - Component library (actually contains gz-physics6::dartsim)
#
# We will also set gz-physics6-dartsim_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-physics6-dartsim_CONFIG_INCLUDED)
  return()
endif()
set(gz-physics6-dartsim_CONFIG_INCLUDED TRUE)

if(NOT gz-physics6-dartsim_FIND_QUIETLY)
  message(STATUS "Looking for gz-physics6-dartsim -- found version 6.3.0")
endif()
...
# dependencies.
if(gz-physics6-dartsim_FIND_REQUIRED)
...
# dependencies.
if(gz-physics6-dartsim_FIND_QUIETLY)
...
if(NOT gz-physics6-dartsim_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-physics6-dartsim")
endif()
find_package(gz-common5 ${gz_package_quiet} ${gz_package_required} COMPONENTS geospatial;graphics;profiler)
find_package(sdformat13 ${gz_package_quiet} ${gz_package_required})
find_package(DART 6.9 CONFIG ${gz_package_quiet} ${gz_package_required} COMPONENTS collision-bullet;collision-ode;utils;utils-urdf)
if(NOT gz-physics6_CONFIG_INCLUDED)
  find_package(gz-physics6 6.3.0 EXACT ${gz_package_quiet} ${gz_package_required})
endif()
find_package(gz-physics6 6.3.0 EXACT ${gz_package_quiet} ${gz_package_required} COMPONENTS sdf;heightmap;mesh)
# --------------------------------

if(NOT TARGET gz-physics6::gz-physics6-dartsim)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-physics6-dartsim-targets.cmake")
  ...
  add_library(gz-physics6::dartsim INTERFACE IMPORTED)
  set_target_properties(gz-physics6::dartsim PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-physics6::gz-physics6-dartsim")
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-physics6::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-physics6::gz-physics6-dartsim")
endif()

set(gz-physics6-dartsim_LIBRARY gz-physics6::gz-physics6-dartsim)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-physics6-dartsim "gz-physics6-dartsim")
