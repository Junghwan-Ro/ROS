...
# Constants.
LIBRARY_NAME = '/home/julia/workspace/build/sdformat13/lib/libsdformat13.so.13.3.0'
LIBRARY_VERSION = '13.3.0'
COMMON_OPTIONS =
...
COMMANDS = {  'sdf' =>
                       ...
                       "  -d [ --describe ] [SPEC VERSION]  Print the aggregated SDFormat spec description. Default version (1.10).\n" +
...
class Cmd
  ...
  def parse(args)
    ...
    opt_parser = OptionParser.new do |opts|
      ...
      opts.on('-d', '--describe [VERSION]', 'Print the aggregated SDFormat spec description. Default version (1.10)') do |v|
        options['describe'] = v
      end
