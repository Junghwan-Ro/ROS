# - Config file for the gz-rendering8-ogre component
#
# This should only be invoked by gz-rendering8-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-rendering8 COMPONENTS ogre)
#
# This creates the following targets:
#
#   Component library target                - gz-rendering8::gz-rendering8-ogre
#   Alternative target name                 - gz-rendering8::ogre
...
# this is discouraged:
#
#   gz-rendering8-ogre_LIBRARY  - Component library (actually contains gz-rendering8::ogre)
#
# We will also set gz-rendering8-ogre_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-rendering8-ogre_CONFIG_INCLUDED)
  return()
endif()
set(gz-rendering8-ogre_CONFIG_INCLUDED TRUE)

if(NOT gz-rendering8-ogre_FIND_QUIETLY)
  message(STATUS "Looking for gz-rendering8-ogre -- found version 8.0.0~pre1")
endif()
...
# dependencies.
if(gz-rendering8-ogre_FIND_REQUIRED)
...
# dependencies.
if(gz-rendering8-ogre_FIND_QUIETLY)
...
if(NOT gz-rendering8-ogre_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-rendering8-ogre")
endif()
...
if(NOT TARGET gz-rendering8::gz-rendering8-ogre)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-rendering8-ogre-targets.cmake")

  # Create a simplified imported target name for the ogre library.
  # You can link to this target instead of the ogre library.
  add_library(gz-rendering8::ogre INTERFACE IMPORTED)
  set_target_properties(gz-rendering8::ogre PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-rendering8::gz-rendering8-ogre")
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-rendering8::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-rendering8::gz-rendering8-ogre")
endif()

set(gz-rendering8-ogre_LIBRARY gz-rendering8::gz-rendering8-ogre)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-rendering8-ogre "gz-rendering8-ogre")
