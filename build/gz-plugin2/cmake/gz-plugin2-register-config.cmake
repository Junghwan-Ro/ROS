# - Config file for the gz-plugin2-register component
#
# This should only be invoked by gz-plugin2-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-plugin2 COMPONENTS register)
#
# This creates the following targets:
#
#   Component library target                - gz-plugin2::gz-plugin2-register
#   Alternative target name                 - gz-plugin2::register
...
# this is discouraged:
#
#   gz-plugin2-register_LIBRARY  - Component library (actually contains gz-plugin2::register)
#
# We will also set gz-plugin2-register_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-plugin2-register_CONFIG_INCLUDED)
  return()
endif()
set(gz-plugin2-register_CONFIG_INCLUDED TRUE)

if(NOT gz-plugin2-register_FIND_QUIETLY)
  message(STATUS "Looking for gz-plugin2-register -- found version 2.0.1")
endif()
...
# dependencies.
if(gz-plugin2-register_FIND_REQUIRED)
...
# dependencies.
if(gz-plugin2-register_FIND_QUIETLY)
...
if(NOT gz-plugin2-register_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-plugin2-register")
endif()
if(NOT gz-plugin2_CONFIG_INCLUDED)
  find_package(gz-plugin2 2.0.1 EXACT ${gz_package_quiet} ${gz_package_required})
endif()
# --------------------------------

if(NOT TARGET gz-plugin2::gz-plugin2-register)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-plugin2-register-targets.cmake")
  ...
  add_library(gz-plugin2::register INTERFACE IMPORTED)
  set_target_properties(gz-plugin2::register PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-plugin2::gz-plugin2-register")
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-plugin2::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-plugin2::gz-plugin2-register")
endif()

set(gz-plugin2-register_LIBRARY gz-plugin2::gz-plugin2-register)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-plugin2-register "gz-plugin2-register")
