...
#ifndef GZ_SIM_JOINT_STATE_PUBLISHER_SYSTEM_EXPORT_HH_
#define GZ_SIM_JOINT_STATE_PUBLISHER_SYSTEM_EXPORT_HH_
...
#ifndef GZ_SIM_JOINT_STATE_PUBLISHER_SYSTEM_VISIBLE
/// For gz-sim8-joint-state-publisher-system developers: Apply this macro to gz-sim8-joint-state-publisher-system
/// functions and classes which consumers of this library will need to be able
/// to call from their own programs or libraries.
#define GZ_SIM_JOINT_STATE_PUBLISHER_SYSTEM_VISIBLE \
  DETAIL_GZ_SIM_JOINT_STATE_PUBLISHER_SYSTEM_VISIBLE
#endif


#ifndef GZ_SIM_JOINT_STATE_PUBLISHER_SYSTEM_HIDDEN
/// For gz-sim8-joint-state-publisher-system developers: Apply this macro to gz-sim8-joint-state-publisher-system
...
/// not tagged with GZ_SIM_JOINT_STATE_PUBLISHER_SYSTEM_VISIBLE, so this does not
/// generally need to be used.
#define GZ_SIM_JOINT_STATE_PUBLISHER_SYSTEM_HIDDEN \
  DETAIL_GZ_SIM_JOINT_STATE_PUBLISHER_SYSTEM_HIDDEN
#endif


#ifndef GZ_DEPRECATED
/// For gz-sim8-joint-state-publisher-system developers: Use this macro to indicate that a
...
#ifndef IGNITION_SIM_JOINT_STATE_PUBLISHER_SYSTEM_VISIBLE
#define IGNITION_SIM_JOINT_STATE_PUBLISHER_SYSTEM_VISIBLE GZ_SIM_JOINT_STATE_PUBLISHER_SYSTEM_VISIBLE
#endif

#ifndef IGNITION_SIM_JOINT_STATE_PUBLISHER_SYSTEM_HIDDEN
#define IGNITION_SIM_JOINT_STATE_PUBLISHER_SYSTEM_HIDDEN GZ_SIM_JOINT_STATE_PUBLISHER_SYSTEM_HIDDEN
#endif
...
#endif  // GZ_SIM_JOINT_STATE_PUBLISHER_SYSTEM_EXPORT_HH_
