# - Config file for the gz-sensors8-magnetometer component
#
# This should only be invoked by gz-sensors8-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-sensors8 COMPONENTS magnetometer)
#
# This creates the following targets:
#
#   Component library target                - gz-sensors8::gz-sensors8-magnetometer
#   Alternative target name                 - gz-sensors8::magnetometer
...
# this is discouraged:
#
#   gz-sensors8-magnetometer_LIBRARY  - Component library (actually contains gz-sensors8::magnetometer)
#
# We will also set gz-sensors8-magnetometer_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-sensors8-magnetometer_CONFIG_INCLUDED)
  return()
endif()
set(gz-sensors8-magnetometer_CONFIG_INCLUDED TRUE)

if(NOT gz-sensors8-magnetometer_FIND_QUIETLY)
  message(STATUS "Looking for gz-sensors8-magnetometer -- found version 8.0.0~pre1")
endif()
...
# dependencies.
if(gz-sensors8-magnetometer_FIND_REQUIRED)
...
# dependencies.
if(gz-sensors8-magnetometer_FIND_QUIETLY)
...
if(NOT gz-sensors8-magnetometer_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-sensors8-magnetometer")
endif()
...
if(NOT TARGET gz-sensors8::gz-sensors8-magnetometer)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-sensors8-magnetometer-targets.cmake")
  ...
  add_library(gz-sensors8::magnetometer INTERFACE IMPORTED)
  set_target_properties(gz-sensors8::magnetometer PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-sensors8::gz-sensors8-magnetometer")
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-sensors8::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-sensors8::gz-sensors8-magnetometer")
endif()

set(gz-sensors8-magnetometer_LIBRARY gz-sensors8::gz-sensors8-magnetometer)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-sensors8-magnetometer "gz-sensors8-magnetometer")
