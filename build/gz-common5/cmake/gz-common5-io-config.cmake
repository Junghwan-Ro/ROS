# - Config file for the gz-common5-io component
#
# This should only be invoked by gz-common5-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-common5 COMPONENTS io)
#
# This creates the following targets:
#
#   Component library target                - gz-common5::gz-common5-io
#   Alternative target name                 - gz-common5::io
...
# this is discouraged:
#
#   gz-common5-io_LIBRARY  - Component library (actually contains gz-common5::io)
#
# We will also set gz-common5-io_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-common5-io_CONFIG_INCLUDED)
  return()
endif()
set(gz-common5-io_CONFIG_INCLUDED TRUE)

if(NOT gz-common5-io_FIND_QUIETLY)
  message(STATUS "Looking for gz-common5-io -- found version 5.3.1")
endif()
...
# dependencies.
if(gz-common5-io_FIND_REQUIRED)
...
if(NOT gz-common5-io_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-common5-io")
endif()
...
if(NOT TARGET gz-common5::gz-common5-io)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-common5-io-targets.cmake")

  # Create a simplified imported target name for the io library.
  # You can link to this target instead of the io library.
  add_library(gz-common5::io INTERFACE IMPORTED)
  set_target_properties(gz-common5::io PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-common5::gz-common5-io")
...
# Link the io library to the "requested" target
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-common5::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-common5::gz-common5-io")
endif()

set(gz-common5-io_LIBRARY gz-common5::gz-common5-io)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-common5-io "gz-common5-io")
