...
if [ ! -f "/home/julia/workspace/build/gz-common5/doxygen/html/index.html" ]; then
  make doc
  if [ ! -f "/home/julia/workspace/build/gz-common5/doxygen/html/index.html" ]; then
...
# Dry run
aws s3 sync --dryrun /home/julia/workspace/build/gz-common5/doxygen/html/ s3://gazebosim.org/api/common/5/
...
if [ "$ans" = "n" ] || [ "$ans" = "N" ]; then
  ...
  aws s3 sync /home/julia/workspace/build/gz-common5/doxygen/html/ s3://gazebosim.org/api/common/5/
