# - Config file for the gz-sim8-gz component
#
# This should only be invoked by gz-sim8-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-sim8 COMPONENTS gz)
#
# This creates the following targets:
#
#   Component library target                - gz-sim8::gz-sim8-gz
#   Alternative target name                 - gz-sim8::gz
...
# this is discouraged:
#
#   gz-sim8-gz_LIBRARY  - Component library (actually contains gz-sim8::gz)
#
# We will also set gz-sim8-gz_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-sim8-gz_CONFIG_INCLUDED)
  return()
endif()
set(gz-sim8-gz_CONFIG_INCLUDED TRUE)

if(NOT gz-sim8-gz_FIND_QUIETLY)
  message(STATUS "Looking for gz-sim8-gz -- found version 8.0.0~pre1")
endif()
...
if(NOT gz-sim8-gz_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-sim8-gz")
endif()
...
if(NOT TARGET gz-sim8::gz-sim8-gz)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-sim8-gz-targets.cmake")

  # Create a simplified imported target name for the gz library.
  # You can link to this target instead of the gz library.
  add_library(gz-sim8::gz INTERFACE IMPORTED)
  set_target_properties(gz-sim8::gz PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-sim8::gz-sim8-gz")
...
# Link the gz library to the "requested" target
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-sim8::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-sim8::gz-sim8-gz")
endif()

set(gz-sim8-gz_LIBRARY gz-sim8::gz-sim8-gz)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-sim8-gz "gz-sim8-gz")
