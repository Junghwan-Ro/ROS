# - Config file for the gz-sensors8-rendering component
#
# This should only be invoked by gz-sensors8-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-sensors8 COMPONENTS rendering)
#
# This creates the following targets:
#
#   Component library target                - gz-sensors8::gz-sensors8-rendering
#   Alternative target name                 - gz-sensors8::rendering
...
# this is discouraged:
#
#   gz-sensors8-rendering_LIBRARY  - Component library (actually contains gz-sensors8::rendering)
#
# We will also set gz-sensors8-rendering_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-sensors8-rendering_CONFIG_INCLUDED)
  return()
endif()
set(gz-sensors8-rendering_CONFIG_INCLUDED TRUE)

if(NOT gz-sensors8-rendering_FIND_QUIETLY)
  message(STATUS "Looking for gz-sensors8-rendering -- found version 8.0.0~pre1")
endif()
...
# dependencies.
if(gz-sensors8-rendering_FIND_REQUIRED)
...
# dependencies.
if(gz-sensors8-rendering_FIND_QUIETLY)
...
if(NOT gz-sensors8-rendering_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-sensors8-rendering")
endif()
...
if(NOT TARGET gz-sensors8::gz-sensors8-rendering)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-sensors8-rendering-targets.cmake")
  ...
  add_library(gz-sensors8::rendering INTERFACE IMPORTED)
  set_target_properties(gz-sensors8::rendering PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-sensors8::gz-sensors8-rendering")
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-sensors8::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-sensors8::gz-sensors8-rendering")
endif()

set(gz-sensors8-rendering_LIBRARY gz-sensors8::gz-sensors8-rendering)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-sensors8-rendering "gz-sensors8-rendering")
