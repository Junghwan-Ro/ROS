# - Config file for the gz-sensors8-wide_angle_camera component
#
# This should only be invoked by gz-sensors8-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-sensors8 COMPONENTS wide_angle_camera)
#
# This creates the following targets:
#
#   Component library target                - gz-sensors8::gz-sensors8-wide_angle_camera
#   Alternative target name                 - gz-sensors8::wide_angle_camera
...
# this is discouraged:
#
#   gz-sensors8-wide_angle_camera_LIBRARY  - Component library (actually contains gz-sensors8::wide_angle_camera)
#
# We will also set gz-sensors8-wide_angle_camera_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-sensors8-wide_angle_camera_CONFIG_INCLUDED)
  return()
endif()
set(gz-sensors8-wide_angle_camera_CONFIG_INCLUDED TRUE)

if(NOT gz-sensors8-wide_angle_camera_FIND_QUIETLY)
  message(STATUS "Looking for gz-sensors8-wide_angle_camera -- found version 8.0.0~pre1")
endif()
...
# dependencies.
if(gz-sensors8-wide_angle_camera_FIND_REQUIRED)
...
# dependencies.
if(gz-sensors8-wide_angle_camera_FIND_QUIETLY)
...
if(NOT gz-sensors8-wide_angle_camera_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-sensors8-wide_angle_camera")
endif()
...
if(NOT TARGET gz-sensors8::gz-sensors8-wide_angle_camera)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-sensors8-wide_angle_camera-targets.cmake")

  # Create a simplified imported target name for the wide_angle_camera library.
  # You can link to this target instead of the wide_angle_camera library.
  add_library(gz-sensors8::wide_angle_camera INTERFACE IMPORTED)
  set_target_properties(gz-sensors8::wide_angle_camera PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-sensors8::gz-sensors8-wide_angle_camera")
...
# Link the wide_angle_camera library to the "requested" target
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-sensors8::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-sensors8::gz-sensors8-wide_angle_camera")
endif()

set(gz-sensors8-wide_angle_camera_LIBRARY gz-sensors8::gz-sensors8-wide_angle_camera)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-sensors8-wide_angle_camera "gz-sensors8-wide_angle_camera")
