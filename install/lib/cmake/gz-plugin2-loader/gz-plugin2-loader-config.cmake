# - Config file for the gz-plugin2-loader component
#
# This should only be invoked by gz-plugin2-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-plugin2 COMPONENTS loader)
#
# This creates the following targets:
#
#   Component library target                - gz-plugin2::gz-plugin2-loader
#   Alternative target name                 - gz-plugin2::loader
...
# this is discouraged:
#
#   gz-plugin2-loader_LIBRARY  - Component library (actually contains gz-plugin2::loader)
#
# We will also set gz-plugin2-loader_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-plugin2-loader_CONFIG_INCLUDED)
  return()
endif()
set(gz-plugin2-loader_CONFIG_INCLUDED TRUE)

if(NOT gz-plugin2-loader_FIND_QUIETLY)
  message(STATUS "Looking for gz-plugin2-loader -- found version 2.0.1")
endif()
...
# dependencies.
if(gz-plugin2-loader_FIND_REQUIRED)
...
# dependencies.
if(gz-plugin2-loader_FIND_QUIETLY)
...
if(NOT gz-plugin2-loader_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-plugin2-loader")
endif()
...
if(NOT TARGET gz-plugin2::gz-plugin2-loader)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-plugin2-loader-targets.cmake")

  # Create a simplified imported target name for the loader library.
  # You can link to this target instead of the loader library.
  add_library(gz-plugin2::loader INTERFACE IMPORTED)
  set_target_properties(gz-plugin2::loader PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-plugin2::gz-plugin2-loader")
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-plugin2::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-plugin2::gz-plugin2-loader")
endif()

set(gz-plugin2-loader_LIBRARY gz-plugin2::gz-plugin2-loader)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-plugin2-loader "gz-plugin2-loader")
