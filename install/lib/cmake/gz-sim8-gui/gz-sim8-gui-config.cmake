# - Config file for the gz-sim8-gui component
#
# This should only be invoked by gz-sim8-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-sim8 COMPONENTS gui)
#
# This creates the following targets:
#
#   Component library target                - gz-sim8::gz-sim8-gui
#   Alternative target name                 - gz-sim8::gui
...
# this is discouraged:
#
#   gz-sim8-gui_LIBRARY  - Component library (actually contains gz-sim8::gui)
#
# We will also set gz-sim8-gui_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-sim8-gui_CONFIG_INCLUDED)
  return()
endif()
set(gz-sim8-gui_CONFIG_INCLUDED TRUE)

if(NOT gz-sim8-gui_FIND_QUIETLY)
  message(STATUS "Looking for gz-sim8-gui -- found version 8.0.0~pre1")
endif()
...
if(NOT gz-sim8-gui_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-sim8-gui")
endif()
...
if(NOT TARGET gz-sim8::gz-sim8-gui)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-sim8-gui-targets.cmake")

  # Create a simplified imported target name for the gui library.
  # You can link to this target instead of the gui library.
  add_library(gz-sim8::gui INTERFACE IMPORTED)
  set_target_properties(gz-sim8::gui PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-sim8::gz-sim8-gui")
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-sim8::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-sim8::gz-sim8-gui")
endif()

set(gz-sim8-gui_LIBRARY gz-sim8::gz-sim8-gui)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-sim8-gui "gz-sim8-gui")
