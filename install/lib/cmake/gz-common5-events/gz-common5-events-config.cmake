# - Config file for the gz-common5-events component
#
# This should only be invoked by gz-common5-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-common5 COMPONENTS events)
#
# This creates the following targets:
#
#   Component library target                - gz-common5::gz-common5-events
#   Alternative target name                 - gz-common5::events
...
# this is discouraged:
#
#   gz-common5-events_LIBRARY  - Component library (actually contains gz-common5::events)
#
# We will also set gz-common5-events_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-common5-events_CONFIG_INCLUDED)
  return()
endif()
set(gz-common5-events_CONFIG_INCLUDED TRUE)

if(NOT gz-common5-events_FIND_QUIETLY)
  message(STATUS "Looking for gz-common5-events -- found version 5.3.1")
endif()
...
# dependencies.
if(gz-common5-events_FIND_REQUIRED)
...
# dependencies.
if(gz-common5-events_FIND_QUIETLY)
...
if(NOT gz-common5-events_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-common5-events")
endif()
...
if(NOT TARGET gz-common5::gz-common5-events)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-common5-events-targets.cmake")

  # Create a simplified imported target name for the events library.
  # You can link to this target instead of the events library.
  add_library(gz-common5::events INTERFACE IMPORTED)
  set_target_properties(gz-common5::events PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-common5::gz-common5-events")
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-common5::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-common5::gz-common5-events")
endif()

set(gz-common5-events_LIBRARY gz-common5::gz-common5-events)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-common5-events "gz-common5-events")
