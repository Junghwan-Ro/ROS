# - Config file for the gz-physics6-bullet-plugin component
#
# This should only be invoked by gz-physics6-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-physics6 COMPONENTS bullet-plugin)
#
# This creates the following targets:
#
#   Component library target                - gz-physics6::gz-physics6-bullet-plugin
#   Alternative target name                 - gz-physics6::bullet-plugin
...
# this is discouraged:
#
#   gz-physics6-bullet-plugin_LIBRARY  - Component library (actually contains gz-physics6::bullet-plugin)
#
# We will also set gz-physics6-bullet-plugin_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-physics6-bullet-plugin_CONFIG_INCLUDED)
  return()
endif()
set(gz-physics6-bullet-plugin_CONFIG_INCLUDED TRUE)

if(NOT gz-physics6-bullet-plugin_FIND_QUIETLY)
  message(STATUS "Looking for gz-physics6-bullet-plugin -- found version 6.3.0")
endif()
...
# dependencies.
if(gz-physics6-bullet-plugin_FIND_REQUIRED)
...
# dependencies.
if(gz-physics6-bullet-plugin_FIND_QUIETLY)
...
if(NOT gz-physics6-bullet-plugin_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-physics6-bullet-plugin")
endif()
if(NOT gz-physics6_CONFIG_INCLUDED)
  find_package(gz-physics6 6.3.0 EXACT ${gz_package_quiet} ${gz_package_required})
endif()
find_package(gz-physics6 6.3.0 EXACT ${gz_package_quiet} ${gz_package_required} COMPONENTS bullet)
# --------------------------------

if(NOT TARGET gz-physics6::gz-physics6-bullet-plugin)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-physics6-bullet-plugin-targets.cmake")
  ...
  add_library(gz-physics6::bullet-plugin INTERFACE IMPORTED)
  set_target_properties(gz-physics6::bullet-plugin PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-physics6::gz-physics6-bullet-plugin")
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-physics6::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-physics6::gz-physics6-bullet-plugin")
endif()

set(gz-physics6-bullet-plugin_LIBRARY gz-physics6::gz-physics6-bullet-plugin)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-physics6-bullet-plugin "gz-physics6-bullet-plugin")
